...
RUN make -f CMakeFiles/Makefile2 pdfalto
#RUN cd /app && git submodule update --init --recursive && cmake -D'ICU_PATH=/app/icu/source/' -D'XPDF_SUBDIR=/app/xpdf-4.00' && make
RUN ./pdfalto
EXPOSE  80
ENV ENV production
CMD ["pdfalto", "-v"]
